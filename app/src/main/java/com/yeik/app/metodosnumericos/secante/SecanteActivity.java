...
public class SecanteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fxEditText = (EditText) findViewById(R.id.secante_fx_edit_text);
        x0EditText = (EditText) findViewById(R.id.secante_x0_edit_text);
        x1EditText = (EditText) findViewById(R.id.secante_x1_edit_text);
        errorEditText = (EditText) findViewById(R.id.secante_error_edit_text);
        iterEditText = (EditText) findViewById(R.id.secante_iter_edit_text);
        evalButton = (Button) findViewById(R.id.secante_eval_button);
        recycler = (RecyclerView) findViewById(R.id.secante_recycler);
            ...
            public void onClick(View view) {
                ...
                if (isValid()) {
                    ...
                    try {
                        ...
                        Stack<Secante> result = evaluator.evaluate(new Secante(fx, x0, x1, 1));

                        LinearLayoutManager layoutManager = new LinearLayoutManager(SecanteActivity.this);
                        recycler.setAdapter(new SecanteAdapter(result));
