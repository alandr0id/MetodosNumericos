...
import com.yeik.app.metodosnumericos.biseccion.BiseccionAdapter;
...
public class FalsaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_falsa);

        fxEditText = (EditText) findViewById(R.id.fp_fx_edit_text);
        x0EditText = (EditText) findViewById(R.id.fp_x0_edit_text);
        x1EditText = (EditText) findViewById(R.id.fp_x1_edit_text);
        errorEditText = (EditText) findViewById(R.id.fp_error_edit_text);
        iterEditText = (EditText) findViewById(R.id.fp_iter_edit_text);
        evalButton = (Button) findViewById(R.id.fp_eval_button);
        recycler = (RecyclerView) findViewById(R.id.fp_recycler);
            ...
            public void onClick(View view) {
                ...
                if (isValid()) {
                    ...
                    try {
                        ...
                        Stack<FalsaPosicion> result = evaluator.evaluate(new FalsaPosicion(fx, x0,
                                x1, 1));
                        LinearLayoutManager layoutManager = new LinearLayoutManager(FalsaActivity.this);
                        recycler.setAdapter(new FalsaAdapter(result));
